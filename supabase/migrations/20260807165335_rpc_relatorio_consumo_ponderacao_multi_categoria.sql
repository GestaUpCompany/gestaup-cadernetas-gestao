...
BEGIN
  ...
  info_lotes AS (
    SELECT
      cpl.lote_id,
      l.nome AS lote_nome,
      -- Média ponderada de peso de entrada
      ...
      -- Média ponderada de peso vivo atual
      CASE WHEN SUM(cpl.quant_atual) > 0 THEN
