...
-- Permitir leitura anonima para relatorios publicos (token valida no app, RLS da tabela nao expoe dados sensiveis)
-- Os precos sao referencia de mercado, nao dados privados. Mas para simplicidade, permitimos SELECT para anon.
