-- RPC de monitoramento de saúde do sistema para o painel super-admin
-- Retorna métricas em tempo real: conexões, usuários ativos, tamanho do banco,
-- queries em execução, tabelas mais pesadas, cron jobs, throughput, cache, índices
