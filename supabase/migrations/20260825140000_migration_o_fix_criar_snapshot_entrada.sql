-- Migration O: Fix criar_snapshot_entrada para modelo por lote
-- - Guard verifica lote_id em vez de lote_categoria_id
-- - GMD planejado buscado de formulacao_categorias_gmd por categoria
