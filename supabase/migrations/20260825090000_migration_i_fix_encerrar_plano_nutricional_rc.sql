-- ============================================================================
-- MIGRATION I — Fix encerrar_plano_nutricional: rc_atual -> rc_final
-- ============================================================================
-- Bug: a função referencia lc.rc_atual, mas a coluna em lote_categorias se
-- chama rc_final (renomeada em migration histórica). Isso faz encerrar_plano
-- falhar com "column lc.rc_atual does not exist", impedindo a Migration H de
-- normalizar planos e impedindo recategorizações que chamam encerrar_plano.
--
-- Correção: substituir lc.rc_atual por lc.rc_final em todo o corpo da função.
-- ============================================================================
