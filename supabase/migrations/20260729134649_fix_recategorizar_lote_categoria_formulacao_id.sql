-- Corrigir bug: quando p_manter_formulacao=true e lote_categoria.formulacao_id IS NULL,
-- buscar formulacao_id do plano nutricional ativo da origem.
...
BEGIN
  ...
  -- 4b. Capturar snapshot completo do lote (estado no momento da transição)
  ...
  -- BUGFIX: quando p_manter_formulacao=true e lote_categoria.formulacao_id IS NULL,
  -- buscar formulacao_id do plano nutricional ativo da origem
  ...
  IF v_tem_plano_origem THEN
    ...
    -- 7b. Ler de volta o snapshot de performance que encerrar_plano_nutricional acabou de criar
    SELECT 
      jsonb_build_object(
...
SELECT 'RPC recategorizar_lote_categoria corrigida (bugfix formulacao_id)' AS status;;
