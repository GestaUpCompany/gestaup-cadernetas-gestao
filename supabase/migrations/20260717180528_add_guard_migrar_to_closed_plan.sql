...
BEGIN
  ...
  IF p_plano_destino_id IS NOT NULL THEN
    ...
    -- Não permitir migrar para plano já encerrado
  ...
  -- Métricas usando baseline do plano
  ...
  INSERT INTO public.planos_nutricionais_snapshots (
    ...
    v_plano_atual.id, v_proximo_plano.id
  );
