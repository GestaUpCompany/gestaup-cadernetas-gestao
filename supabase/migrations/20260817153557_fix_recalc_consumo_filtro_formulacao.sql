...
BEGIN
  ...
  --    Próximo registro da MESMA formulação (alinhado com calcular_consumo_registro_anterior)
  ...
  -- 2. Recalcular consumo do registro anterior da MESMA formulação
  --    Só se cabeças/peso mudaram (não se apenas kg_cocho mudou)
