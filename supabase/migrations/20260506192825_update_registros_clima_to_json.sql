-- Drop the table and recreate with JSON structure for pluviometers
DROP TABLE IF EXISTS registros_clima CASCADE;
...
CREATE INDEX idx_registros_clima_medicoes ON registros_clima USING GIN (medicoes);
