  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const [
        ...
        supabase.from('registros_maternidade').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_enfermaria').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_pastagens').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_rodeio').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_suplementacao').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_bebedouros').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_movimentacao').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_morte').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_clima').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_abastecimento').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_alimentacao').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_limpeza').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_operacoes_maquinas').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_almoxarifado').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
        supabase.from('registros_manutencao_maquinas').select('*', { count: 'exact', head: true }).eq('fazenda_id', fazendaId).is('deleted_at', null),
